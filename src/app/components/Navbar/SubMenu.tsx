...
const SubMenu =  React.memo( ( {clicked}:{clicked:boolean} ) => {
  return (
    <div  >
             <div className={` hidden_menu bg-black transition-transform duration-700 ease-in-out md:h-[90vh] h-[90vh] ${clicked ? 'translate-y-0' : '-translate-y-full'} absolute top-0 left-0 w-full overflow-hidden`}>
