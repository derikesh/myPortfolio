      ...
      <div className='content_right_work flex flex-col justify-center md:px-6 px-2 md:py-8 py-4' >
        ...
        <div className="flex gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 black text-black px-4 py-2 bg-gray-100 rounded-lg hover:bg-black hover:text-white transition-colors duration-200 md:text-[0.9vw] text-[3.6vw]"
          >
